...
client2 = MongoClient("mongodb+srv://arcaozkan:passWord125@cluster0.nkqth.mongodb.net/?retryWrites=true&w=majority");
...
x_meas=[]
for result in game_results:
    difficulty=(result["param1"]+result["param3"])/2
    score=result["smoothness"]*20+result["completeness"]*20+result["duration"]*20+result["steadiness"]*20+difficulty*20
    Scores.append(score/100) 
    x_meas.append([result["param1"],result["param3"]])
    print(result["param1"],result["param3"])
    print(score/100)
